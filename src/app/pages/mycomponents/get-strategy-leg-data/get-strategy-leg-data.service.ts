...
@Injectable()
export class GetStrategyLegDataService {

    /*
     * TODO: dataUrl needs to be relative, not absolute!!! 
     */
  private dataUrl = 'http://192.168.23.61:64301/strategy-microservice.1.0.0/getLegData/';
    
  constructor (private http: Http) {}
  
  getDataFromUrl(strategyCode: string): Observable<StrategyLegData> {
